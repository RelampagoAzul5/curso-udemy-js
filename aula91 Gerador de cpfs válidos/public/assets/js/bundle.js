...
___CSS_LOADER_EXPORT___.push([module.id, `:root{
  --primary-color: #4de8c9;
  --primary-color-darker: #2f8b78;
  --secondary-color: #a9ff59;
}
*{
...
.cpf-gerado {
  ...
  margin-bottom: 40px;
  letter-spacing: 5px;
}`, "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AACA;EACE,wBAAwB;EACxB,+BAA+B;EAC/B,0BAA0B;AAC5B;AACA;EACE,sBAAsB;EACtB,UAAU;AACZ;AACA;EACE,SAAS;EACT,UAAU;EACV,gCAAgC;EAChC,oCAAoC;EACpC,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,gBAAgB;EAChB,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,cAAc;EACd,WAAW;EACX,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,eAAe;AACjB;AACA;EACE,uCAAuC;AACzC;AACA;EACE,YAAY;EACZ,gCAAgC;EAChC,WAAW;EACX,eAAe;EACf,gBAAgB;EAChB,YAAY;EACZ,eAAe;EACf,gBAAgB;EAChB,cAAc;EACd,WAAW;EACX,mBAAmB;AACrB;AACA;EACE,6CAA6C;AAC/C;;AAEA;EACE,kBAAkB;EAClB,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,2BAA2B;EAC3B,kBAAkB;EAClB,iBAAiB;EACjB,mBAAmB;EACnB,mBAAmB;AACrB","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n:root{\n  --primary-color: #4de8c9;\n  --primary-color-darker: #2f8b78;\n  --secondary-color: #a9ff59;\n}\n*{\n  box-sizing: border-box;\n  outline: 0;\n}\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-family: 'Open Sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  max-width: 640px;\n  margin: 50px auto;\n  background: #fff;\n  padding: 20px;\n  border-radius: 10px;\n}\n\nform input, form label, form button{\n  display: block;\n  width: 100%;\n  margin-bottom: 10px;\n}\n\nform input{\n  font-size: 24px;\n  height: 50px;\n  padding: 0 20px;\n}\nform input:focus{\n  outline: 3px solid var(--primary-color);\n}\nbutton{\n  border: none;\n  background: var(--primary-color);\n  color: #fff;\n  font-size: 18px;\n  font-weight: 700;\n  height: 50px;\n  cursor: pointer;\n  margin-top: 30px;\n  display: block;\n  width: 100%;\n  margin-bottom: 10px;\n}\nbutton:hover {\n  background-color: var(--primary-color-darker);\n}\n\n.container h1 {\n  text-align: center;\n  margin-bottom: 40px;\n}\n\n.cpf-gerado {\n  font-size: 2rem;\n  color: var(--primary-color);\n  text-align: center;\n  font-weight: bold;\n  margin-bottom: 40px;\n  letter-spacing: 5px;\n}"],"sourceRoot":""}]);
// Exports
